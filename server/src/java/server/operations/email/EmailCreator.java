...
public class EmailCreator {
    ...
    final ArrayList<EmailObject> createEmailObjects(final Timetable entityList) throws ScheduleCreationException {
    ...
    final ArrayList<EmailObject> createPasswordChangeMail(
