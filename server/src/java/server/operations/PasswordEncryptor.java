...
public class PasswordEncryptor {
    ...
    /**
     * Creates a String of the given length, containing random characters from the given alphabets, but at least one character
     * from each alphabet. If there are more than 'length' alphabets, one random character is chosen from each of the 'length'
     * first alphabets. <br />
     * <br />
     * At least one alphabet must be given. If an empty String or <code>null</code> is encountered as an alphabet, an
    ...
    /**
     * Returns a StringBuffer containing 'n' characters chosen randomly from the given alphabet.
     * 
     * @param alphabet The alphabet to choose from
     * @param n The number of characters to choose
     * @return A StringBufer with 'n' characters chosen randomly from the given alphabet
     */
